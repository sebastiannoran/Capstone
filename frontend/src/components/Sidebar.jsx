...
//           open ? "w-80 bg-fuchsia-700 duration-300" : "w-20 duration-100"
//         } relative`}
//       >
//         <div
//           className={`h-[600px] overflow-y-auto ${open ? "w-72" : "w-20"} pr-5 ${
...
const Sidebar = ({ majors, college }) => {
  ...
  return (
    <div className="fixed bg-[#272727] text-white h-screen w-20 drop-shadow-[0px_0px_5px_rgba(0,0,0,0.50)]">
      ...
      >
        <div
          className={`h-[600px] overflow-y-auto ${open ? "w-72" : "w-20"} pr-10 ${
